...
class AF_Theme_info{
		...
		public function elegant_magazine_register_info_page() {
			...
			// Add info page.
			add_theme_page( $this->menu_name, $this->page_name, 'activate_plugins', $this->page_slug, array( $this, 'elegant_magazine_render_page' ), 1 );
		}
		...
		function elegant_magazine_load_files(){
