    ...
    function elegant_magazine_dashboard_notice_content(){
		if ( file_exists( WP_PLUGIN_DIR . '/af-companion/af-companion.php' ) ) {
			if(is_plugin_active('af-companion/af-companion.php')){
				$af_companion_title = __( 'Get Starter Sites', 'elegant-magazine' );
				$af_companion_url = site_url( ).'/wp-admin/admin.php?page=af-companion';
			}else{
            $af_companion_title = __( 'Activate AF Companion', 'elegant-magazine' );
            ...
            $af_companion_title = __( 'Install AF Companion', 'elegant-magazine' );
		...
		$demo_link = "https://afthemes.com/products/elegant-magazine/";
		$notice_starter_msg =sprintf(
			...
			__( 'General info', 'elegant-magazine' ),
			esc_html__( 'All of the features provided by the theme are now ready to use; Here, we have gathered all of the essential details and helpful links for you and your better experience with the theme. Once again, Thanks for using our theme!', 'elegant-magazine' ),
			$af_companion_url,
			$af_companion_title,
			esc_url($demo_link),
		...
		$notice_external_msg =sprintf(
			...
			esc_html__( 'Return to your dashboard', 'elegant-magazine' )
