...
$wp_customize->add_panel('frontpage_option_panel',
    array(
        'title'      => __('Frontpage Options', 'elegant-magazine'),
        'priority'   => 199,
...
$wp_customize->add_section('frontpage_advertisement_settings',
    array(
        'title'      => __('Advertisement', 'elegant-magazine'),
        'priority'   => 50,
        'capability' => 'edit_theme_options',
...
$wp_customize->add_control(
    new WP_Customize_Cropped_Image_Control($wp_customize, 'banner_advertisement_section',
        array(
            'label'       => __('Banner Section Advertisement', 'elegant-magazine'),
            'description' => sprintf(__('Recommended Size %1$s px X %2$s px', 'elegant-magazine'), 1170, 90),
...
$wp_customize->add_control('banner_advertisement_section_url',
    array(
        'label'    => __('URL Link', 'elegant-magazine'),
        'section'  => 'frontpage_advertisement_settings',
        'type'     => 'text',
        'priority' => 130,
    )
...
$wp_customize->add_section('frontpage_ticker_settings',
    array(
        'title'      => __('Ticker news', 'elegant-magazine'),
        'priority'   => 50,
        'capability' => 'edit_theme_options',
        'panel'      => 'frontpage_option_panel',
    )
...
$wp_customize->add_control('show_ticker_news_section',
	array(
		'label'    => __('Enable Ticker News', 'elegant-magazine'),
...
$wp_customize->add_control('ticker_section_title',
	array(
		'label'    => __('Ticker Title', 'elegant-magazine'),
		'section'  => 'frontpage_ticker_settings',
		'type'     => 'text',
		'priority' => 15,
...
$wp_customize->add_control(new Elegant_Magazine_Dropdown_Taxonomies_Control($wp_customize, 'select_ticker_news_category',
		array(
			'label'       => __('Ticker News Category', 'elegant-magazine'),
			'description' => __('Select category to be shown on ticker ', 'elegant-magazine'),
			'section'     => 'frontpage_ticker_settings',
...
$wp_customize->add_section('frontpage_main_news_settings',
    array(
        'title'      => __('Main banner news', 'elegant-magazine'),
        'priority'   => 50,
        'capability' => 'edit_theme_options',
        'panel'      => 'frontpage_option_panel',
    )
...
$wp_customize->add_control('show_main_news_section',
    array(
        'label'    => __('Enable main news section', 'elegant-magazine'),
...
$wp_customize->add_control(new Elegant_Magazine_Dropdown_Taxonomies_Control($wp_customize, 'select_slider_news_category',
    array(
        'label'       => __('Slider news category', 'elegant-magazine'),
        'description' => __('Select category to be shown on slider ', 'elegant-magazine'),
        'section'     => 'frontpage_main_news_settings',
        'type'        => 'dropdown-taxonomies',
        'taxonomy'    => 'category',
        'priority'    => 23,
...
$wp_customize->add_control(new Elegant_Magazine_Dropdown_Taxonomies_Control($wp_customize, 'select_featured_news_category',
    array(
        'label'       => __('Featured news category', 'elegant-magazine'),
        'description' => __('Select category to be shown on featured section ', 'elegant-magazine'),
        'section'     => 'frontpage_main_news_settings',
        'type'        => 'dropdown-taxonomies',
        'taxonomy'    => 'category',
        'priority'    => 24,
...
$wp_customize->add_control( 'frontpage_content_status',
    array(
        'label'    => __( 'Enable static page content', 'elegant-magazine' ),
...
$wp_customize->add_control( 'frontpage_content_alignment',
    array(
        'label'       => __('Frontpage Content alignment', 'elegant-magazine'),
        'description' => __('Select frontpage content alignment', 'elegant-magazine'),
        'section'     => 'frontpage_layout_settings',
        'type'        => 'select',
        'choices'               => array(
            'align-content-left' => __( 'Home Content - Home Sidebar', 'elegant-magazine' ),
            'align-content-right' => __( 'Home Sidebar - Home Content', 'elegant-magazine' ),
            'full-width-content' => __( 'Only Home Content', 'elegant-magazine' )
        ),
        'priority'    => 130,
    ));
