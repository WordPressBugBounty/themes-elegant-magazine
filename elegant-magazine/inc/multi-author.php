<?php 
if(!function_exists('elegant_magazine_by_author')){
    function elegant_magazine_by_author(){
        global $post;
            ...
            if(isset($awpa_post_authors) && !empty($awpa_post_authors) &&  $multiauthor_settings == true){
                foreach ($awpa_post_authors as $key=>$author_id) {
                    ...
                    if (strpos($author_id, $needle) !== false) {
                     ...
                     elegant_magazine_author_list($post_id,$author_id,$author_type, $author_avatar=false);
...
if(!function_exists('elegant_magazine_author_list')){
function elegant_magazine_author_list($post_id='',$author_id='',$author_type='',$author_avatar=false){
